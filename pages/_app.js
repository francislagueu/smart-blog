...
function MyApp({ Component, pageProps }) {
  //create local state to save account information after signing in
  ...
  //uses web3 modal to connect to the user's wallet
      ...
      <div>
        <nav className={nav}>
          <div className={header}>
            <Link href="/">
              <a><img src='/logo.svg' alt="React Logo" style={{width: '50px'}}/></a>
            </Link>
            <Link href="/">
              <a>
        ...
        <div className={container}>
          <AccountText.Provider value={account}>
            <Component {...pageProps} connect={connect} />
          </AccountText.Provider>
        </div>
      </div>
  );
}

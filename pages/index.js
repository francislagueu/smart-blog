...
export default function Home(props) {
  //posts are fetched on the server side and passed in as a props
  const {posts} = props;
  const account = useContext(AccountText);
  ...
  return (
    <div>
      <div className={postList}>
        {
          //map ovr the posts array and render a button with the post title
...
export async function getServerSideProps(){
  /*
  here is where we check to see the current environment variable
